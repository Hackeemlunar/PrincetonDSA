...
public class LookupIndex {
    ...
    public static void main(String[] args) {
        ...
        edu.princeton.cs.algs4.ST<String, edu.princeton.cs.algs4.Queue<String>> st = new edu.princeton.cs.algs4.ST<String, edu.princeton.cs.algs4.Queue<String>>();
        edu.princeton.cs.algs4.ST<String, edu.princeton.cs.algs4.Queue<String>> ts = new ST<String, edu.princeton.cs.algs4.Queue<String>>();
        ...
        while (in.hasNextLine()) {
            ...
            for (int i = 1; i < fields.length; i++) {
                String val = fields[i];
                if (!st.contains(key)) st.put(key, new edu.princeton.cs.algs4.Queue<String>());
        ...
        edu.princeton.cs.algs4.StdOut.println("Done indexing");
        ...
        while (!edu.princeton.cs.algs4.StdIn.isEmpty()) {
            ...
            if (st.contains(query))
                for (String vals : st.get(query))
                    edu.princeton.cs.algs4.StdOut.println("  " + vals);
